...
class Graph_Dataset2(Dataset):
    ...
    def raw_file_names(self):
        self.raw_file_users=self.raw_dir+'/数据提供.xlsx'
    ...
    def get_users(self,data_path):
        user_fraud = pd.read_excel(open(data_path, 'rb'), sheet_name='纯涉诈卡', dtype='str')
        user_change = pd.read_excel(open(data_path, 'rb'), sheet_name='突变涉诈卡', dtype='str')
        user_non_fraud = pd.read_excel(open(data_path, 'rb'), sheet_name='白名单用户', dtype='str')
