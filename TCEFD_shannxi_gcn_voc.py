...
class GATModel(nn.Module):
    def __init__(self, in_channels, hide_channels, out_channels, num_heads, dropout=0.6):
        ...
        print(hide_channels)
        self.conv1 = GCNConv(in_channels, hide_channels, dropout=dropout)

        self.conv2 = GCNConv(hide_channels, out_channels, dropout=dropout)
...
class TCCNN(torch.nn.Module):
    def __init__(
        ...
        self.mlp = MLP([out_features, 512, 256, 2], dropout=dropout, norm=None)
